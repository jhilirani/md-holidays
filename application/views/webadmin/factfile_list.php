...
<table cellspacing=5 cellpadding=5 width=90% border=0 >
  ...
  <tr>
    <td style="padding-left:10px;padding-bottom:10px;"><input type="button" name="AddBtn" id="AddBtn" value="Add Factfile" onclick="ShowAddAdminBox();" class="btn btn-primary"/></td>
  </tr>
...
function ShowAddAdminBox()
{
 ...
 function ShowEditBox(id)
 {
	...
	$('#EditBox').fadeIn(2500);
	$('#Editfactfile').val(DataArr[id]['factfile']);
	...
	$('#factfileId').val(DataArr[id]['factfileId']);
...
function AskDelete(id){
	...
	function(){
		location.href='<?php echo base_url()?>webadmin/factfile/delete/'+id;
	});
	/*if(confirm('Are you sure to delete(Y/N) ?'))
	{
		location.href='<?php //echo base_url()?>admin/factfile/delete/'+id;
	}*/
	return false;
}
 </script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="ListTestLable" height="20px;">
    ...
    <td><?php echo $InerArr->factfile;?></td>
    <?php /*<td>if($InerArr->Featured=='1'){echo 'Featured';}else{?>
        <a href="<?php echo ADMIN_BASE_URL.'factfile/featured/'.$InerArr->factfileId;?>" class="AdminDashBoardLinkText"> Make Featured </a>
    <?php }</td>*/?>
    <td><?php echo ($InerArr->status=='1')?'Active':'Inactive';?></td>
    <td>
	<?php if($InerArr->status=='1'){$action=0;}else{$action=1;}?>
	<a href="<?php echo ADMIN_BASE_URL.'factfile/change_status/'.$InerArr->factfileId.'/'.$action;?>" class="AdminDashBoardLinkText"><?php if($InerArr->status=='1'){?><img src="<?php echo SiteImagesURL.'webadmin/';?>active1.png" alt="Inactive" title="Active" /><?php }else{?><img src="<?php echo SiteImagesURL.'webadmin/';?>inactive1.png" alt="Inactive" title="Inactive" /><?php }?></a>
	&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="ShowEditBox('<?php echo $InerArr->factfileId;?>');" class="AdminDashBoardLinkText"><img src="<?php echo SiteImagesURL.'webadmin/';?>edit.png" width="15" height="15" title="Edit"/></a>
	&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="AskDelete('<?php echo $InerArr->factfileId;?>');" class="AdminDashBoardLinkText"><img src="<?php echo SiteImagesURL.'webadmin/';?>delete.png" width="15" height="15" title="Delete"/></a>
	</td> 
  </tr>
  <script language="javascript">
  DataArr[<?php echo $InerArr->factfileId?>]=new Array();
  DataArr[<?php echo $InerArr->factfileId?>]['factfileId']='<?php echo $InerArr->factfileId?>';
  DataArr[<?php echo $InerArr->factfileId?>]['factfile']='<?php echo $InerArr->factfile?>';
  DataArr[<?php echo $InerArr->factfileId?>]['status']='<?php echo $InerArr->status?>';
  </script>
  ...
  <tr>
    <td><form name="AdminEdit" id="AdminEdit" method="post" action="<?=base_url()?>webadmin/factfile/edit/">
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="EditBox" style="display:none;">
  <tr>
    <th colspan="4"><span class="PageHeading">Factfile Edit of <span id="EditBoxTitle"></span></span></th>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top" class="ListHeadingLable"> factfile </td>
    <td align="left" valign="top"><label><strong>:</strong></label></td>
    <td align="left" valign="top"><input name="Editfactfile" type="text" id="Editfactfile"  class="required form-control" /></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><input type="submit" name="Submit3" value="Submit" class="btn btn-success"/>&nbsp;&nbsp;&nbsp;
	  ...
	  <input  type="hidden" name="factfileId"  id="factfileId" value=""/></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    <td><form name="AdminAdd" id="AdminAdd" method="post" action="<?=base_url()?>webadmin/factfile/add" >
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="AddBox" style="display:none;">
  <tr>
    ...
    <th width="66%" align="left" valign="top" scope="col"><span class="PageHeading">Factfile Add</span></th>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><label><strong>:</strong></label></td>
    <td align="left" valign="top"><input name="factfile" type="text" id="factfile"  class="required form-control"  /></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
...
$(document).ready(function(){
	...
	$('#Editfactfile').live('blur',function(){
		var CheckEditUserNameAjaxURL='<?php echo ADMIN_BASE_URL.'ajax/check_edit_category_name/'?>';
		var CheckEditUserNameAjaxData='factfile='+$(this).val()+'&factfileId='+$('#factfileId').val();
		$.ajax({
		   type: "POST",
		   ...
		   success: function(msg){ 
		   	if(msg=='1'){
				alert($('#Editfactfile').val()+' has already used,Please enter a new one.');
				$('#Editfactfile').val('');
				return false;
			}else{
				return true;
