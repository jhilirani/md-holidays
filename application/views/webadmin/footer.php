...
<script src="<?php echo SiteAssetsURL; ?>plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?php echo SiteAssetsURL; ?>plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- page script -->
...
<script type="text/javascript">
var dataManageActionMessage='<?php echo $this->session->flashdata('Message');?>';
...
$(document).ready(function(){
   if(dataManageActionMessage!=""){
         showMessage(dataManageActionMessage,'success');
     } 
});
</script>    
</body>
