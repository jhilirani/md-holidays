...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="ListTestLable">
    ...
    <td><a href="javascript:void(0);" onclick="javascript:ShowEditBox('<?php echo $InerArr->ConstantID?>')"><img src="<?php echo $SiteImagesURL.'admin/';?>edit.png" width="15" height="15" title="Edit"/></a></td> 
  </tr>
  <script language="javascript">
