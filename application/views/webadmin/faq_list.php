...
<table cellspacing=5 cellpadding=5 width=90% border=0 >
  ...
  <tr>
    <td style="padding-left:10px;"><input type="button" name="AddBtn" id="AddBtn" value="Add FAQ" onclick="ShowAddAdminBox();" class="common_button"/></td>
  </tr>
...
function AskDelete(id)
{
	...
	{
		location.href='<?php echo base_url()?>admin/faq/delete/'+id;
	}
	return false;
}
 </script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="ListTestLable" height="20px;">
	...
	<a href="<?php echo base_url().'admin/faq/change_status/'.$InerArr->FaqID.'/'.$action;?>" class="AdminDashBoardLinkText"><?php if($InerArr->Status=='1'){?><img src="<?php echo $SiteImagesURL.'admin/';?>active1.png" alt="Inactive" title="Active" /><?php }else{?><img src="<?php echo $SiteImagesURL.'admin/';?>inactive1.png" alt="Inactive" title="Inactive" /><?php }?></a>
	&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="ShowEditBox('<?php echo $InerArr->FaqID;?>');" class="AdminDashBoardLinkText"><img src="<?php echo $SiteImagesURL.'admin/';?>edit.png" width="15" height="15" title="Edit"/></a>
	&nbsp;&nbsp;
	<a href="javascript:void(0);" onclick="AskDelete('<?php echo $InerArr->FaqID;?>');" class="AdminDashBoardLinkText"><img src="<?php echo $SiteImagesURL.'admin/';?>delete.png" width="15" height="15" title="Delete"/></a>
	</td> 
  </tr>
  <script language="javascript">
  ...
  <tr>
    <td><form name="AdminEdit" id="AdminEdit" method="post" action="<?=base_url()?>admin/faq/edit/">
...
<input name="EditStatus" type="radio" value="0"  class="required"/></td>
  ...
  <tr>
    <td><form name="AdminAdd" id="AdminAdd" method="post" action="<?=base_url()?>admin/faq/add" >
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="AddBox" style="display:none;">
  ...
  <tr>
    ...
    <td align="left" valign="top" class="ListHeadingLable"> Question </td>
    <td align="left" valign="top"><label><strong>:</strong></label></td>
    <td align="left" valign="top"><input name="Question" type="text" id="Question"  class="required email" /></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
