...
<table cellspacing=5 cellpadding=5 width=90% border=0 >
  ...
  <tr>
    <td style="padding-left:10px;padding-bottom:10px;"><input type="button" name="AddBtn" id="AddBtn" value="Add Facility" onclick="ShowAddAdminBox();" class="btn btn-primary"/></td>
  </tr>
