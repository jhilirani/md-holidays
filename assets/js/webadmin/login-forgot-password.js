...
myJsMain.login=function(){
    ...
    $('#mtmv_admin_login_form').validate({rules: loginValidationRules,onsubmit: true});
    $('#mtmv_admin_login_form').submit(function(e) {
        e.preventDefault();
        if ($(this).valid()) {
            ...
            //$('#LoadingDiv').fadeIn();
            myJsMain.commonFunction.ajaxSubmit($(this),myJsMain.adminBaseURL+'ajax_controller/check_login', loginFormCallback);
        }
    });
    ...
    function loginFormCallback(resultData){
        ...
        if(resultData.result=='bad'){
            myJsMain.commonFunction.retailershangoutAlert(myJsMain.SystemMessageName,resultData.msg);
